(function(){
    ...
    const PRODUCTION_TOP_LEVEL_DOMAIN = 'com';
    ...
    self.addEventListener('fetch', function(event) {
        ...
        else if (isAssetServedFromLocalhost()){
            let localURL = serveFromLocalhost(requestURL);
    ...
    function serveFromLocalhost(url){
        const pattern = new RegExp(`http.*\.${PRODUCTION_TOP_LEVEL_DOMAIN}\/`);
        return url.replace(pattern, LOCALHOST_URL);
    }
